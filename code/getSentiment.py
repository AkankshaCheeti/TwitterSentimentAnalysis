...
def getSentiment(stock,company):
    ...
    #data = pd.read_csv(r"/Users/akankshacheeti/Downloads/sucessfulhandles.csv" , encoding = 'utf8')
    #data = pd.read_csv(r"./outputfinal/AMZNrandom usertimeslines 2018 to 2022/AMZNrandom.csv" , encoding = 'utf8')
    #data = pd.read_csv(r"./outputfinal/" +stock+"sucessfulhandles"+".csv" , encoding = 'utf8')
...
def getrealstock(data,stock):
    ...
    stock_data.to_csv("./output/" + "realstockraw_" + stock + ".csv")
    ...
    result_data.to_csv("./output/" + "randomrealstock_" + stock + ".csv")
    return result_data